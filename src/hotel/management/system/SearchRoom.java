...
public class SearchRoom extends JFrame implements ActionListener {
    ...
    SearchRoom() {
        ...
        c1 = new JComboBox(new String[]{"Single Bed", "Double Bed", "All"});
...
//    setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == b1) {
            try {
                String bt = (String) c1.getSelectedItem();
                String str = "select * from room where bed_type = '" + c1.getSelectedItem() + "'";
                String str2 = "select * from room where availability = 'Available' AND bed_type = '" + bt + "'";
                Conn c = new Conn();
                ResultSet rs;

                if (c2.isSelected()) {
                    if (bt.equals("All")) {
                        str2 = "select * from room where availability = 'Available'";
